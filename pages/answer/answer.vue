		...
		<view class="grace-list grace-body">
			<view class="grace-list-items">
				<view class="grace-list-body">
					<view class="grace-list-title-text">点击复制客服QQ号,添加好友后咨询</view>
				</view>
			</view>
			<view class="grace-list-items" @click="showDialog(answer.qq)" v-for="(answer,index) in answers" v-bind:key="index">
				<view class="icons grace-icons icon-kf3 grace-red"></view>
				<view class="grace-list-body">
					<view class="grace-list-title-text">{{answer.qq}}</view>
				</view>
			</view>
		</view>
	</view>
